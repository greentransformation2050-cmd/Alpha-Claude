...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Alpha-Claude/.claude
                  → checks /home/user/Alpha-Claude/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Alpha-Claude/.claude/gsd-core
                  → writes to /home/user/Alpha-Claude/.claude/gsd-core/hooks/
