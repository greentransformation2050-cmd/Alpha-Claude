...
See /home/user/Alpha-Claude/.claude/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /home/user/Alpha-Claude/.claude/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /home/user/Alpha-Claude/.claude/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /home/user/Alpha-Claude/.claude/gsd-core/templates/discovery.md
...
Use /home/user/Alpha-Claude/.claude/gsd-core/templates/discovery.md.
