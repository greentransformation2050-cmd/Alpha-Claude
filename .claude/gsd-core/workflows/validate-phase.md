...
```
Agent(
  prompt="Read /home/user/Alpha-Claude/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Alpha-Claude/.claude/gsd-core/templates/VALIDATION.md`
