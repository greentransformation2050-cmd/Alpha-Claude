...
ones). Reference: @/home/user/Alpha-Claude/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/user/Alpha-Claude/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/user/Alpha-Claude/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/user/Alpha-Claude/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/user/Alpha-Claude/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/user/Alpha-Claude/.claude/gsd-core/templates/spec.md.
