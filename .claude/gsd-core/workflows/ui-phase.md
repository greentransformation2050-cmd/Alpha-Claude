...
```markdown
Read /home/user/Alpha-Claude/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/Alpha-Claude/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/Alpha-Claude/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/user/Alpha-Claude/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/user/Alpha-Claude/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/user/Alpha-Claude/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/user/Alpha-Claude/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
