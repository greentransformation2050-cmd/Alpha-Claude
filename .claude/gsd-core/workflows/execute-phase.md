...
@/home/user/Alpha-Claude/.claude/gsd-core/references/agent-contracts.md
@/home/user/Alpha-Claude/.claude/gsd-core/references/context-budget.md
@/home/user/Alpha-Claude/.claude/gsd-core/references/gates.md
</required_reading>
...
@/home/user/Alpha-Claude/.claude/gsd-core/references/execute-phase-response-language.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/home/user/Alpha-Claude/.claude/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/home/user/Alpha-Claude/.claude/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `/home/user/Alpha-Claude/.claude/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/home/user/Alpha-Claude/.claude/gsd-core/workflows/execute-plan.md` **inline**
...
@/home/user/Alpha-Claude/.claude/gsd-core/references/execute-phase-wave-guard.md

@/home/user/Alpha-Claude/.claude/gsd-core/references/execute-phase-context-guard.md
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @/home/user/Alpha-Claude/.claude/gsd-core/references/checkpoints.md
       @/home/user/Alpha-Claude/.claude/gsd-core/references/tdd.md
       @/home/user/Alpha-Claude/.claude/gsd-core/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@/home/user/Alpha-Claude/.claude/gsd-core/references/executor-examples.md'}
       </execution_context>
...
@/home/user/Alpha-Claude/.claude/gsd-core/references/execute-phase-quota-recovery.md

@/home/user/Alpha-Claude/.claude/gsd-core/references/execute-phase-between-wave-reset.md
...
**If gaps_found:**
@/home/user/Alpha-Claude/.claude/gsd-core/references/execute-phase-requirement-revert.md
```
...
@/home/user/Alpha-Claude/.claude/gsd-core/references/offer-next.md
</step>
