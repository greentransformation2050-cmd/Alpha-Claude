...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Alpha-Claude/.claude/.gsd-surface.json`
(sibling to `/home/user/Alpha-Claude/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/Alpha-Claude/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/Alpha-Claude/.claude/skills`).
...
`/home/user/Alpha-Claude/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/Alpha-Claude/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/Alpha-Claude/.claude/.gsd-surface.json`
Install profile marker: `/home/user/Alpha-Claude/.claude/.gsd-profile`
Skill dirs: `/home/user/Alpha-Claude/.claude/skills/gsd-*/`
Engine module: `/home/user/Alpha-Claude/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Alpha-Claude/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
