...
<execution_context>
@/home/user/Alpha-Claude/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/Alpha-Claude/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
