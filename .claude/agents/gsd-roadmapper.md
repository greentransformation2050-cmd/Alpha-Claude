...
Reference full template: `/home/user/Alpha-Claude/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Alpha-Claude/.claude/gsd-core/templates/state.md`.
