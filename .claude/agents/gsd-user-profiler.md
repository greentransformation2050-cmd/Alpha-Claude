...
<reference>
@/home/user/Alpha-Claude/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/Alpha-Claude/.claude/gsd-core/references/user-profiling.md` to load:
